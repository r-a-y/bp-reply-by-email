...
class BP_Docs_Comment_RBE_Extension extends BP_Reply_By_Email_Extension {
	...
	public function __construct() {
		...
		$this->bootstrap( array(
			...
			'item_id_param' => 'bpdg',           // parameter name for your 'item_id'; in our case 'item_id' is the group ID
			                                     // hence the shortname 'bpdg'
			'secondary_item_id_param' => 'bpdc', // parameter name for your 'secondary_item_id'; in our case
	...
	public function post_by_email( $connection, $i, $headers, $params, $body, $user_id ) {
		$comment_id = $params[$this->data['secondary_item_id_param']];
		...
		if ( ! empty( $comment_id ) ) {
			...
			// get group ID
			$group_id = $params[$this->data['item_id_param']];
